...
function UpdateVoucher(){
    ...
    useEffect(() => {
      ...
      const deleteVoucher = async () => {  
        ...
        try {
            response = await fetch(import.meta.env.VITE_API_URL+'/vouchers/deleteVoucher', {
                method: 'DELETE',
                headers: {
      ...
      const onFinish = async (values) => { 
            ...
            try {
                response = await fetch(import.meta.env.VITE_API_URL+'/vouchers/updateVoucher', {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                    },
                        ...
                        <Content
                            ...
                            <div style={{
                                ...
                                initialValues={{
                                    ...
                                    Validity: moment(voucher.Validity),
                                ...
                                <div style={{width:'100%', alignContent:'center', display:'flex', textAlign:'center', }}>
                                    <div style={{width:'100%', alignContent:'center', flex:'1', textAlign:'center'}}>
                                        <Form.Item>
                                    ...
                                    <div style={{width:'100%', alignContent:'center', flex:'1', textAlign:'center'}}>
                                        ...
                                        <Button block type="primary" danger onClick={deleteVoucher}
                                         style={{width:'40%' ,fontFamily:'Kalam', textAlign:'center'}}>
                                            Delete Voucher
                                        </Button>
