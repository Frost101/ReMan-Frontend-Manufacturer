...
import { CodeSandboxCircleFilled, HomeOutlined, DeleteFilled, SearchOutlined,  ShopTwoTone } from "@ant-design/icons";
...
function RemoveFromMarketPlace(){
    ...
    const handleOk = async() => {
        ...
        let response,receivedData;
        try{
            response = await fetch(import.meta.env.VITE_API_URL+'/batch/removeFromMarket', {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
            ...
            if(response.status == 200){
                notification.success({
                    message: `Successfully removed batch(es) from marketplace`,
                ...
                notification.error({
                    message: `Error in removing batch(es) from marketplace`,
                    duration: 2, //? Duration in seconds
                });
                setModalVisible(false);
            }
    ...
    return (
        ...
        <div style={{ fontSize: '30px', fontFamily: 'Kalam', textAlign: 'center', color:'blue' }}>
            Confirm Removing From Marketplace
        </div>}     
        open={modalVisible}
            ...
            <div style={{display:'flex',justifyContent:'center', flexDirection: 'column', alignItems: 'center'}}>
                ...
                <div style={{
                    ...
                    fontFamily: 'Kalam',
                        ...
                        Following batches will be removed from marketplace: <br />
                        ...
                        <div style={{display:'flex', justifyContent:'center'}}>
                            <div style={{flex:'1',alignContent:'left'}}>
                                ...
                                >
                                    ...
                                    <Breadcrumb.Item><p style={{fontFamily:'Kalam', color:'Highlight', fontSize:'20px'}}>Remove from Marketplace</p></Breadcrumb.Item>
                                </Breadcrumb>
                            </div>
                            <div style={{flex:'1',
                            ...
                            <div style={{display:'flex', justifyContent:'center'}}>
                                ...
                                <div onClick={showModal} style={{flex:'1', display:'flex', justifyContent:'right', justifySelf:'right'}}>
                                    <div style={{cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',paddingLeft:'5px' }}>
                                        <DeleteFilled  style={{ fontSize: '50px', color: '#08c', marginLeft: '30px' }} />
...
export default RemoveFromMarketPlace;