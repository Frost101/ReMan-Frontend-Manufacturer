...
function RentedInventories(){
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try{
                response = await fetch(import.meta.env.VITE_API_URL+'/leaseInventory/ownLeasedInventories', {
                method: 'POST',
                headers: {
            ...
            <Layout>
                ...
                <Layout style={{marginLeft, minHeight:'100vh'}}>
                    ...
                    style={{
                        ...
                        <div style={{display:'flex', justifyContent:'center'}}>
                            <div style={{flex:'1',alignContent:'left'}}>
                                ...
                                >
                                    ...
                                    <Breadcrumb.Item><p style={{fontFamily:'Kalam', color:'Highlight', fontSize:'20px'}}>Rented Inventories </p></Breadcrumb.Item>
                                </Breadcrumb>
                            </div>
                            <div style={{flex:'1',
                        ...
                        >
                             <div style={{display:'flex', justifyContent:'center'}}>
                                <p style={{color:'#001529',fontSize:'50px',fontFamily:'Kalam'}}>Rented Inventories  <br></br>
                                    <span style={{fontSize:'20px',fontFamily:'Kalam', color:'purple'}}> (Click on the inventory to extend occupied date)</span>
                                </p>
                            ...
                            
                            {
                                inventoryList.length !=0 && inventoryList.map((inventory, index) => {
                                    return <RentedInventoryCard key = {index} value={
                                        {
                                            inventory: inventory,
...
export default RentedInventories;