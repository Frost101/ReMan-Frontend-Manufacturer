import { Layout, theme,InputNumber, Breadcrumb,notification, Spin, Form, Card, Row, Col, Divider, Modal,Input, Avatar, Button, Result } from "antd";
                        ...
                        <div style={{display:'flex', justifyContent:'center'}}>
                            <div style={{flex:'1',alignContent:'left'}}>
                                ...
                                >
                                    ...
                                    <Breadcrumb.Item><p style={{fontFamily:'Kalam', color:'black', fontSize:'20px'}}>Details </p></Breadcrumb.Item>
                                    <Breadcrumb.Item><p style={{fontFamily:'Kalam', color:'Highlight', fontSize:'20px'}}>Rent Success </p></Breadcrumb.Item>
                                </Breadcrumb>
                            </div>
                            <div style={{flex:'1',
